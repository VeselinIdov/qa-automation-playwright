...
const system = [
    ...
    'someone should open.',
    '',
    'Output GitHub-flavored Markdown for a CI build summary, in this order and',
    'nothing else:',
    '',
    '1. One sentence: how many failures, and whether the build is worth blocking',
    '   on. Lead with the worst classification present.',
    '2. A table — | Test | Verdict | Next step | — one row per failure, verdict in',
    '   bold, next step at most six words ("open the trace", "file a bug",',
    '   "re-run", "fix the locator"). This is the part people actually read.',
    '3. One short section per failure, in the table order, headed by the test',
    '   name: what the evidence shows, then what to do. Two or three sentences.',
    '   Name the exact artifact to open — the trace or screenshot path from the',
    '   summary — rather than saying "check the logs".',
    '',
    'Write for someone scanning a red build at 9am who has not seen this test',
    'before. No preamble, no restating the rubric, no advice about test strategy',
    'in general.',
    '',
    '# Rubric',
    '',
